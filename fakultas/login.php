<?php
require '../koneksi.php';
if (isset($_SESSION['login_fakultas'])) header("location: index.php");
...
if (isset($_POST['login'])) {
  ...
  $result = mysqli_query($conn, "SELECT * FROM tb_fakultas WHERE username = '$username' AND password = '$password'");
